...
function Course() {
  ...
  const url =
    "https://first-ki55.onrender.com/course/" +
    username +
    "/" +
    coursename +
    "/founder/" +
    foundername; //"/course/:username/:crname/founder/:founderName"
  // const url = "https://first-ki55.onrender.com" + path;     //"/course/:username/:crname/founder/:founderName"
  ...
  async function addLike() {
    const likeURL =
      "https://first-ki55.onrender.com/like/" +
      username +
      "/" +
      coursename +
      "/founder/" +
  ...
  async function unLike() {
    setLoading(true);
    const unlikeURL =
      "https://first-ki55.onrender.com/unlike/" +
      username +
      "/" +
      coursename +
      "/founder/" +
        ...
        <div className="mainCourseDiv">
          ...
          <div className="courseRightDiv">
            ...
            <div className="courseUpperDiv">
              ...
              <h1 className="notvTitle">{courseDetails.courseName}</h1>
            </div>
