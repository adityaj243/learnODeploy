...
function Insert() {
  ...
  const handleSubmit = (e) => {
    ...
    async function launch() {
      ...
      const resp = await axios.post(
        "https://first-ki55.onrender.com/insert/" + username,
        obj1
      );
    }
    ...
    launch();
    setLoading(false);
    toast("Successfully uploaded course");
  };
  //-------------------------------------------------------------------------------------------------
  ...
  async function removeVideoFromList(Name) {
    ...
    try {
      ...
      const resp = await axios.post(
        "https://first-ki55.onrender.com/deleteCloudinaryVideo",
        { pub: pubidtemp }
      );
      alert(resp.data);
    } catch (err) {
                ...
                <div className="insertFormDiv">
                  ...
                  <div className="inserFormButtonDiv">
                    <div className="btnsInsert">
                      <button onClick={addFile}>ADD VIDEO</button>
                      <button
                        onClick={() => {
