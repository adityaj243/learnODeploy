...
function Play() {
  ...
  async function getScreenshots() {
    const url =
      "https://first-ki55.onrender.com/image/get/" +
      username +
      "/" +
      courseName +
      "/" +
  ...
  async function deleteScreenshot(pubid) {
    ...
    const deleteSSurl =
      "https://first-ki55.onrender.com/delete/screenshot/" +
      username +
      "/" +
      courseName +
      "/founder/" +
      ...
      <div key={index} className="PlayImageAndButtonContainer">
        <div className="imageContainerPlay">
          ...
          <img
            ...
            src={single.link}
            // src={"https://first-ki55.onrender.com/" + single}
            alt="test"
            height="auto"
            width="100%"
  ...
  async function capture() {
    ...
    try {
      ...
      const url2 =
        "https://first-ki55.onrender.com/image/upload/" +
        username +
        "/" +
        courseName +
        "/" +
  ...
  return (
    <div className="play">
      ...
      <div className={preview}>
        ...
        <HorizontalScroll className="bigshow">
          {imagePathArray && imagePathArray.map(element)}
        </HorizontalScroll>
